...
import by.alex.busbooking.dto.exception.ErrorCodeDTO;
import by.alex.busbooking.dto.exception.ExceptionResponseDTO;
import by.alex.busbooking.dto.exception.ValidationResponseDTO;
...
public class GlobalExceptionHandler {
    ...
    @ExceptionHandler(ParseWeatherException.class)
    public ResponseEntity<ExceptionResponseDTO> handleParseWeatherException(ParseWeatherException e) {
        ExceptionResponseDTO exceptionResponseDTO = new ExceptionResponseDTO();
        exceptionResponseDTO.setException(e.getClass().getName());
        exceptionResponseDTO.setMessage(e.getMessage());
    ...
    @ExceptionHandler({NotEnoughPlacesException.class, DifferentRoutesException.class, DifferentCitiesException.class, MostActiveUserException.class})
    public ResponseEntity<ExceptionResponseDTO> handleLogicExceptions(RuntimeException e) {
        ExceptionResponseDTO exceptionResponseDTO = new ExceptionResponseDTO();
        exceptionResponseDTO.setException(e.getClass().getName());
        exceptionResponseDTO.setMessage(e.getMessage());
        exceptionResponseDTO.setCode(ErrorCodeDTO.LOGIC_ERROR.getCode());
